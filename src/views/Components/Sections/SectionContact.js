      ...
      <div className={classes.container}>
        ...
        <div className={classes.address}>
          ...
          <div className={classes.homeText}>
            C-404/405 - Placement Cell, SRM IST, Kattankulathur, Chennai -
            603203
          </div>
        </div>
        ...
        <div className={classes.email}>
          <div className={classes.Icon}>
            <div className={classes.homeIcon} style={{ marginTop: "30px" }}>
              {" "}
              @{" "}
            </div>
          </div>
          <div className={classes.homeText}>srmmarsroverteam@gmail.com</div>
        </div>
        ...
        <a href="https://www.facebook.com/srmteamrudra">
          <div
            id="facebookContact"
            className={classNames(classes.socialOver, classes.facebook)}
          ></div>
          <div
            onMouseEnter={() => {
              document.getElementById("facebookContact").style.transform =
                "scale(1.1)";
              setTimeout(() => {
        ...
        <a href="https://www.instagram.com/team_rudra/">
          <div
            id="instagramContact"
            className={classNames(classes.socialOver, classes.instagram)}
          ></div>
          <div
            onMouseEnter={() => {
              document.getElementById("instagramContact").style.transform =
                "scale(1.1)";
              setTimeout(() => {
        ...
        <a href="https://www.youtube.com/channel/UC2Lu4ABOxd43mizJGFATF_w">
          <div
            id="youtubeContact"
            className={classNames(classes.socialOver, classes.youtube)}
          ></div>
          <div
            onMouseEnter={() => {
              document.getElementById("youtubeContact").style.transform =
                "scale(1.1)";
              setTimeout(() => {
